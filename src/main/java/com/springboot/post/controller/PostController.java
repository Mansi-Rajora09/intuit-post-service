...
import com.springboot.post.utils.AppConstants;
import com.springboot.post.utils.Validation;
...
public class PostController {
    ...
    public PostController(PostService postService,Validation validation) {
   ...
   // @PreAuthorize("hasRole('ADMIN')")
    ...
    public ResponseEntity<PostDto> createPost(@Valid @RequestBody PostDto postDto){
        validation.validatecreatePost(postDto);
